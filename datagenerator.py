...
<head>
    ...
    <title>datagenerator.py (editing)</title>
...
data-base-url="/"
data-file-path="datagenerator.py"
...
<script src="/static/edit/js/main.min.js?v=70ee9ac2ae9a9640d6c459b2c141534b" type="text/javascript" charset="utf-8"></script>
